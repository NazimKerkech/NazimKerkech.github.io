---
layout: distill
title: "The problem of Propositional Satisfiability: Study and comparison of solvers"
...
# Introduction
Theoretical computer science is a subject that holds the key to addressing some of the problems that transcend our existence<d-footnote>This formulation is to be taken figuratively or literally if we consider <a href="https://physics.mit.edu/faculty/max-tegmark/">Max Tegmark</a>'s suggestion of the "<a href="https://arxiv.org/abs/0704.0646">Mathematical Universe</a>" </d-footnote>. $\mathsf{P}$ VS $\mathsf{NP}$ is one of such problems and SAT could be a starting point to answer this problem. 
